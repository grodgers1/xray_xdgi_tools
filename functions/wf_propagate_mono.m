function [I_z] = wf_propagate_mono(wf0,z,E,dx,width,d_source,varargin)
...
I = zeros(length(x),length(z)); % initialize
for dis = 1:length(z)
...
I_z = I; % incoherently sum different energy contributions
